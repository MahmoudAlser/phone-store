...
<head>
    ...
    <title>PhoneStore - تسجيل الدخول</title>
    ...
    <style>
        ...
        .remember-wrap input[type="checkbox"] { accent-color: #e94560; width: 16px; height: 16px; }
    </style>
</head>
<body>
                ...
                <div class="auth-card">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-5 auth-card-left d-none d-lg-flex">
                            ...
                            <h2>مرحباً بعودتك!</h2>
                            <p>سجّل دخولك وتصفح أحدث عروض الهواتف الذكية بأفضل الأسعار</p>
                        </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="remember-wrap">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="auth-link mr-auto">نسيت كلمة المرور؟</a>
                                    @endif
                                </div>
                                ...
                                @if (Route::has('register'))
                                    <div class="text-center mt-3">
                                        <span style="color:#888; font-size:0.88rem;">ليس لديك حساب؟</span>
                                        <a href="{{ route('register') }}" class="auth-link mr-1">إنشاء حساب مجاناً</a>
                                    </div>
                                @endif
                            </form>
                        </div>
